...
@when('we attempt to fetch events with the ID\'s "{event_ids}" requesting cost ranges')
@vcr.use_cassette(
...
@then("the event has cost range")
def the_event_has_cost_range(context):
    assert context.event.cost_range


@then('the cost range min seatprice is "{price}"')
...
@then('the cost range max seatprice is "{price}"')
...
@then('the cost range min surcharge is "{price}"')
...
@then('the cost range max surcharge is "{price}"')
...
@then('the no singles cost range min seatprice is "{price}"')
...
@then('the no singles cost range max seatprice is "{price}"')
...
@then('the no singles cost range min surcharge is "{price}"')
...
@then('the no singles cost range max surcharge is "{price}"')
...
@then('the no singles cost range currency is "{currency}"')
...
@then('the no singles valid quanities are "{quantities}"')
...
@then("the cost range has offers")
