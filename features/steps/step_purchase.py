...
@vcr_post.use_cassette(
    "fixtures/cassettes/purchase-event-availability.yaml", record_mode="new_episodes"
)
...
@given("I have reserved tickets for my customer for this event")
@vcr_post.use_cassette(
    "fixtures/cassettes/purchase-reservation.yaml", record_mode="new_episodes"
)
...
@given("my user has provided valid customer information")
...
@given("my user has provided invalid customer information")
...
@given("my user has provided valid credit card details")
...
@given("my user has provided invalid credit card details")
...
@when("I purchase the tickets")
@vcr_post.use_cassette(
    "fixtures/cassettes/purchase-purchase.yaml", record_mode="new_episodes"
)
...
@then("then an exception is raised")
...
def i_get_an_error_for_bad_customer_details(context):
    assert_that(
        ...
        equal_to("Country code 'foobar' in customer data is invalid"),
    )
...
@given("I have returned from a successful external payment")
@vcr_post.use_cassette(
    "fixtures/cassettes/purchase-callout.yaml", record_mode="new_episodes"
)
...
@given("I have returned from a failed external payment")
@vcr_post.use_cassette(
    "fixtures/cassettes/purchase-failed-callout.yaml", record_mode="new_episodes"
)
...
@vcr_post.use_cassette(
    "fixtures/cassettes/purchase-next-callout.yaml", record_mode="new_episodes"
)
def i_ask_for_the_next_redirect(context):
    ...
    status, callout, _ = context.client.next_callout(
        context.this_token, next_token, context.callout_return_params
    )
