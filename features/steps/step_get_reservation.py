...
def then_the_reservation_response_is_the_same_as_the_original(context):
    ...
    assert (
        context.reservation.trolley.transaction_uuid
        == context.get_reservation.trolley.transaction_uuid
    )
    assert (
        context.reservation.trolley.order_count
        == context.get_reservation.trolley.order_count
    )
    assert (
        context.reservation.trolley.minutes_left
        == context.get_reservation.trolley.minutes_left
    )
