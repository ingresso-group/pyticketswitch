...
class TestClient:
    ...
    def test_make_request_with_subuser(self, monkeypatch):
        client = Client(
            user="beatles", password="lovemedo", sub_user="ringo", use_decimal=True
        )
        fake_response = FakeResponse(status_code=200, json={"lol": "beans"})
        fake_get = Mock(return_value=fake_response)
        session = Mock(spec=requests.Session)
    ...
    def test_make_request_with_tracking_id(self, monkeypatch):
        client = Client(
            user="user", password="pass", tracking_id="xyz", use_decimal=True
        )
        ...
        fake_get.assert_called_with(
            "https://api.ticketswitch.com/f13/events.v1/",
            auth=(b"user", b"pass"),
            params={"tsw_session_track_id": "xyz"},
            headers={
                "Accept-Language": "en-GB",
                "User-Agent": "pyticketswitch {}".format(pyticketswitch.__version__),
            },
    ...
    def test_make_request_when_using_per_request_tracking_id(self, monkeypatch):
        ...
        fake_get.assert_called_with(
            "https://api.ticketswitch.com/f13/events.v1/",
            auth=(b"user", b"pass"),
            params={"tsw_session_track_id": "123"},
            headers={
                "Accept-Language": "en-GB",
                "User-Agent": "pyticketswitch {}".format(pyticketswitch.__version__),
            },
        ...
        fake_get.assert_called_with(
            "https://api.ticketswitch.com/f13/events.v1/",
            auth=(b"user", b"pass"),
            params={"tsw_session_track_id": "456"},
            headers={
                "Accept-Language": "en-GB",
                "User-Agent": "pyticketswitch {}".format(pyticketswitch.__version__),
            },
    ...
    def test_make_request_no_contents_raises(self, client, monkeypatch):
        ...
        fake_response = FakeResponseRaisesValueError(
    ...
    def test_list_events_geolocation(self, client, mock_make_request):
        client.list_events(latitude=51.52961137, longitude=-0.10601562, radius=10)
    ...
    def test_list_events_invalid_geolocation(self, client):
        ...
        with pytest.raises(exceptions.InvalidGeoParameters):
            client.list_events(latitude=51.52961137, radius=10)
    ...
    def test_list_events_misc_kwargs(self, client, mock_make_request):
        ...
        mock_make_request.assert_called_with("events.v1", {"foobar": "lolbeans"})
    ...
    def test_get_events_event_list(self, client, mock_make_request_for_events):
        ...
        mock_make_request_for_events.assert_called_with(
            "events_by_id.v1",
            {
    ...
    def test_get_months_misc_kwargs(self, client, mock_make_request):
        ...
        mock_make_request.assert_called_with(
            "months.v1", {"event_id": "6IF", "foobar": "lolbeans"}
        )
    ...
    def test_list_performances_cost_range(self, client, mock_make_request):
        ...
        mock_make_request.assert_called_with(
            "performances.v1", {"event_id": "ABC123", "req_cost_range": True}
        )
    ...
    def test_list_performances_availability(self, client, mock_make_request):
        ...
        mock_make_request.assert_called_with(
            "performances.v1", {"event_id": "ABC123", "req_avail_details": True}
        )
    ...
    def test_list_performances_with_start_date(self, client, mock_make_request):
        client.list_performances("ABC123", start_date=datetime(2016, 7, 23, 0, 7, 25))
    ...
    def test_list_performancess_with_end_date(self, client, mock_make_request):
        client.list_performances("ABC123", end_date=datetime(2016, 7, 23, 0, 7, 25))
    ...
    def test_get_performances_misc_kwargs(
        self, client, mock_make_request_for_performances
    ):
        client.get_performances(["6IF-1", "25DR-2"], foobar="lolbeans")

        mock_make_request_for_performances.assert_called_with(
            "performances_by_id.v1",
            {
    ...
    def test_get_availability_with_number_of_seats(
        self, client, mock_make_request_for_availability
    ):
        client.get_availability("6IF-1", number_of_seats=2)

        mock_make_request_for_availability.assert_called_with(
            "availability.v1",
            {
                "perf_id": "6IF-1",
                "no_of_seats": 2,
    ...
    def test_get_availability_with_discounts(
        self, client, mock_make_request_for_availability
    ):
        client.get_availability("6IF-1", discounts=True)

        mock_make_request_for_availability.assert_called_with(
            "availability.v1", {"perf_id": "6IF-1", "add_discounts": True}
        )

    def test_get_availability_with_example_seats(
        self, client, mock_make_request_for_availability
    ):
        client.get_availability("6IF-1", example_seats=True)

        mock_make_request_for_availability.assert_called_with(
            "availability.v1", {"perf_id": "6IF-1", "add_example_seats": True}
        )

    def test_get_availability_with_seat_blocks(
        self, client, mock_make_request_for_availability
    ):
        client.get_availability("6IF-1", seat_blocks=True)

        mock_make_request_for_availability.assert_called_with(
            "availability.v1", {"perf_id": "6IF-1", "add_seat_blocks": True}
        )

    def test_get_availability_with_user_commission(
        self, client, mock_make_request_for_availability
    ):
    ...
    def test_get_send_methods(self, client, monkeypatch):
        response = {
            ...
            "send_methods": {
                "send_method": [{"send_code": "COBO"}, {"send_code": "POST"}]
            },
        }
    ...
    def test_get_discounts(self, client, monkeypatch):
        response = {
            ...
            "discounts": {
                "discount": [{"discount_code": "ADULT"}, {"discount_code": "CHILD"}]
            },
        }
        ...
        discounts, meta = client.get_discounts(
            "ABC123-1", "STALLS", "A/pool", an_optional_kwarg="kwarg_value"
        )
    ...
    def test_trolley_params_with_price_band_code(self, client):
        ...
        assert params == {"price_band_code": "A"}

    def test_trolley_params_with_item_numbers_to_remove(self, client):
        params = client._trolley_params(
            item_numbers_to_remove=[1, 2, 3], token="ABC123"
        )

        assert params == {"trolley_token": "ABC123", "remove_items_list": "1,2,3"}
    ...
    def test_trolley_params_with_send_codes(self, client):
        ...
        assert params == {"nimax_send_code": "POST", "see_send_code": "COBO"}
    ...
    def test_make_reservation(self, client, monkeypatch):
        response = {
            "reserved_trolley": {"transaction_uuid": "DEF456"},
            "currency_code": "gbp",
            "currency_details": {
                "gbp": {
                    "currency_code": "gbp",
    ...
    def test_get_reservation(self, client, monkeypatch):
        ...
        response = {
            "reserved_trolley": {"transaction_uuid": transaction_uuid},
            "currency_code": "gbp",
            "currency_details": {
                "gbp": {
                    "currency_code": "gbp",
    ...
    def test_make_reservation_with_unavailable_order_but_successfull_reservation(
    ...
    def test_get_reservation_with_unavailable_order_but_successful_reservation(
        self, client, monkeypatch
    ):
        """
        This checks that when we raise an exception on unavailable order, but
    ...
    def test_get_status_with_trans(self, client, monkeypatch):
        response = {
            "trolley_contents": {"transaction_id": "DEF456"},
            "currency_code": "gbp",
            "currency_details": {
                "gbp": {
                    "currency_code": "gbp",
    ...
    def test_make_purchase_card_details(self, client, monkeypatch):
        ...
        status, callout, meta = client.make_purchase(
            "abc123", customer, payment_method=card_details
        )
        ...
        mock_make_request.assert_called_with(
            "purchase.v1", expected_params, method=POST
        )
    ...
    def test_make_purchase_redirection(self, client, monkeypatch):
        ...
        status, callout, meta = client.make_purchase(
            "abc123", customer, payment_method=redirection_details
        )
    ...
    def test_make_purchase_opting_out_of_confirmation_email(self, client, monkeypatch):
        ...
        status, callout, meta = client.make_purchase(
            "abc123", customer, send_confirmation_email=False
        )
    ...
    def test_get_purchase(self, client, monkeypatch):
        ...
        mock_make_request.assert_called_with(
            "purchase_page_archive.v1", expected_params, method=GET
        )
    ...
    def test_next_callout(self, client, monkeypatch):
        ...
        mock_make_request.assert_called_with(
            "callback.v1/this.abc123/next.def456", expected_params, method=POST
        )
    ...
    def test_auth_can_be_overridden_with_subclass(self, monkeypatch):
        ...
        client = MyClient("gandalf", auth_key="speakfriendandenter", use_decimal=True)
    ...
    def test_cancel_purchase(self, client, monkeypatch):
        ...
        cancellation_result, meta = client.cancel_purchase(
            "abc123", cancel_items_list=[1, 2, 3]
        )
