...
class TestSeatBlock:
    ...
    def test_from_api_data(self):
        ...
        seat_block = SeatBlock.from_api_data(
            data, separator=".", restricted_view_seats=[], seats_by_text_message={}
        )
...
class TestSeat:
    ...
    def test_from_api_data(self):
        ...
        assert (
            seat.seat_apple_wallet_urls.apple_wallet_gen_url
            == "https://apple-wallet-api-dev.ticketswitch.io/generate_passes"
        )
        assert (
            seat.seat_google_pay_urls.gpay_jwt_url
            == "https://google-wallet-api-dev.ticketswitch.io/transactions/googlePayJWT"
        )
        assert (
            seat.seat_google_pay_urls.gpay_save_url
            == "https://google-wallet-api-dev.ticketswitch.io/transactions/saveToGooglePay"
        )
