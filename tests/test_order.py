...
class TestTicketOrder:
    ...
    def test_from_api_data(self):
        ...
        assert isinstance(
            ticket_order.raw_total_surcharge_tax_sub_component, (int, float)
        )
    ...
    def test_from_api_data_with_decimal(self):
        ...
        assert isinstance(
            ticket_order.raw_total_surcharge_tax_sub_component, (int, Decimal)
        )
...
class TestOrder:
    ...
    def test_from_api_data(self):
        ...
        data = {
            ...
            "send_method": {
                ...
                "permitted_countries": {
                    "country": [
                        {"country_code": "ie", "country_desc": "Ireland"},
                        {"country_code": "uk", "country_desc": "United Kingdom"},
                    ]
                },
            },
    ...
    def test_from_api_data_with_decimal(self):
        ...
        assert order.total_including_send_cost() == (
            51 + Decimal("5.40") + Decimal("3.5")
        )
