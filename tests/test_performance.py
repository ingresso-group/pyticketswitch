...
class TestPerformance:
                        ...
                        "price_band": [
                            {
                                "avail_detail": [
                                    {
                                        "avail_currency": {"currency_code": "gbp"},
    ...
    def test_repr_with_date(self):
        ...
        assert repr(performance) == "<Performance ABC1-23: 2017-02-08T14:08:00>"

    def test_repr_without_date(self):
        performance = Performance("ABC1-23", "ABC1")
        assert repr(performance) == "<Performance ABC1-23>"
...
class TestPerformanceMeta:
    ...
    def test_from_api_data(self):
        data = {
            ...
            "results": {
                "has_perf_names": True,
                "performance": [{"perf_id": "6IF-B1H", "event_id": "6IF"}],
                "paging_status": {
