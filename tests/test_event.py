...
def data():
    return {
        "meta_event_component_events": {"event": [{"event_id": "META123"}]},
        "event_id": "ABC1",
        "event_status": "live",
        ...
        "area_code": "AREACODE",
        "lingo_data": {"lingo_code": "theatre"},
        "classes": {"theatre": "Theatre", "amazeballs": "Amazeballs"},
        ...
        "cost_range": {
            ...
            "no_singles_cost_range": {
                ...
                "min_seatprice": 18,
                "min_surcharge": 0,
                "quantity_options": {"valid_quantity_bitmask": 126},
