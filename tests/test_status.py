...
class TestStatus:
    ...
    def test_from_api_data(self):
        ...
        data = {
            ...
            "accepted_payment_cards": {"amex": "American Express", "visa": "Visa"},
        ...
        assert status.reserved_at == datetime.datetime(
            2016, 11, 9, 18, 19, 27, tzinfo=self.ZULU
        )
        assert status.purchased_at == datetime.datetime(
            2016, 11, 11, 12, 34, 49, tzinfo=self.ZULU
        )
